...
public class ScopeController {
    ...
    @ApiOperation(value = "批量保存快递员业务范围")
    ...
    @ApiOperation(value = "删除快递员业务范围信息")
     ...
     */
    @GetMapping("/courier")
    @ApiOperation(value = "获取快递员业务范围列表")
